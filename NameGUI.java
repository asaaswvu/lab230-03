...
class NameGUI extends JFrame implements ActionListener{
    ...
    NameGUI(){
        ...
        JButton btnHull = new JButton("HULL");
 	...
 	btnHull.setActionCommand("hull");  
        btnHull.addActionListener(this);
 
        //Add components to proper panels
        panelTop.add(btnSample);
        panelTop.add(btnQuit);
        
        panelMiddle.add(btnHull);
    ...
    public void actionPerformed(ActionEvent evt) {
        ...
        switch (evt.getActionCommand()){
            ...
            case "help" :
                ...
                break;
	    case "hull":
		JOptionPane.showMessageDialog(this, "The HULL has to be the strongest part of the boat   - Erin Hull" );
		break;
