...
class NameGUI extends JFrame implements ActionListener{
	...
	JButton btnChiang = new JButton("Show My Name");
	...
	btnChiang.setActionCommand("name");
	btnChiang.addActionListener(this);
 
        //Add components to proper panels
        panelTop.add(btnSample);
        panelTop.add(btnQuit);
        
        panelMiddle.add(btnChiang);
    ...
    public void actionPerformed(ActionEvent evt) {
        ...
        switch (evt.getActionCommand()){
            ...
            case "help" :
                ...
                break;
		case "name":
		JOptionPane.showMessageDialog(this,"Chun-Wei Chiang","My name",JOptionPane.PLAIN_MESSAGE);
		break;
