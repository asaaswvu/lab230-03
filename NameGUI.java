...
class NameGUI extends JFrame implements ActionListener{
	...
	JButton btnSmith = new JButton("Smith");
	...
	btnSmith.setActionCommand("smith");
	btnSmith.addActionListener(this);
 
        //Add components to proper panels
        panelTop.add(btnSample);
        panelTop.add(btnQuit);
        
	panelMiddle.add(btnSmith);
    ...
    public void actionPerformed(ActionEvent evt) {
        ...
        switch (evt.getActionCommand()){
            ...
            case "help" :
                ...
                break;
	    case "smith" :
		JOptionPane.showMessageDialog(this,"My name is Benjamin Smith","Name Box",JOptionPane.PLAIN_MESSAGE);
		break;
        }
    }
