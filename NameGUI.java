...
class NameGUI extends JFrame implements ActionListener{
	...
	JButton btnGantzer = new JButton("Gantzer");
	...
	btnGantzer.setActionCommand("gantzer");  
        btnGantzer.addActionListener(this);
 
        //Add components to proper panels
        panelTop.add(btnSample);
        panelTop.add(btnQuit);
        
	panelMiddle.add(btnGantzer);
    ...
    public void actionPerformed(ActionEvent evt) {
        ...
        switch (evt.getActionCommand()){
            ...
            case "help" :
                ...
                break;
                case "gantzer" :
                JOptionPane.showMessageDialog(this,"Tanner Gantzer","Name Box",JOptionPane.PLAIN_MESSAGE);
                break;
        }
    }
