...
class NameGUI extends JFrame implements ActionListener{
	...
	JButton btnWap = new JButton("Bor Bor");
	...
	btnSample.setActionCommand("sample");  //yours will have to be unique
        btnSample.addActionListener(this);
	btnWap.setActionCommand("Bor Bor");
	btnWap.addActionListener(this);
    ...
    public void actionPerformed(ActionEvent evt) {
        ...
        switch (evt.getActionCommand()){
            ...
            case "help" :
                ...
                break;
	    case "Bor Bor":
		JOptionPane.showMessageDialog(this,"It's Boris","WTF",JOptionPane.PLAIN_MESSAGE);
                break;
